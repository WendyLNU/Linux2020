        ...
        <div class="result-content">
          <table class="result-tab" width="100%">
            ...
            <?php
              ...
              $pagesize=20;
              $sql = "select a.roomid,b.typename,a.location,a.status,a.remarks from room a,roomtype b where a.typeid=b.typeid and a.".@$_POST["search-type"]." like ('%".@$_POST["keywords"]."%')";
              //echo $sql;
              ...
              $sql="select a.roomid,b.typename,a.location,a.status,a.remarks from room a,roomtype b where a.typeid=b.typeid and a.".@$_POST["search-type"]." like ('%".@$_POST["keywords"]."%') order by a.roomid desc limit $startno,$pagesize";
              //echo $sql;
              $rs=mysqli_query($db_link,$sql);
              if(!$rs)
              {
              ...
              while($rows=mysqli_fetch_assoc($rs))
              {
                ...
                echo "<th class='tc'>";
                echo "<a href='admin_roommod.php?mid=".$rows["roomid"]."'  class='link-update'>修改</a>&nbsp;&nbsp;<a href='delete.php?mid=".$rows["roomid"]."' class='link-del''>删除</a>";
                echo "</th>";
                echo "</tr>";
              }
            ?>
