        ...
        <form id="myform" name="myform" method="post" action="update.php?mtid=<?php echo $rows[0] ?>">
          <table width="100%" height="173" border="0" align="center" cellpadding="2" cellspacing="1" class="result-tab">
            ...
            <tr>
              ...
              <td class="td_bg"> <input name="bednum" type="text" id="bednum" value="<?php echo $rows[3] ?>" size="30" maxlength="50" /></td>
            </tr>
            <tr>
              <td align="right" class="td_bg">早餐：</td>
              <td class="td_bg">
                <select name="hasFood">
            ...
            <tr>
              ...
              <td class="td_bg">
                <select name="hasNet">
                  <option value="<?php echo $rows[5] ?>" selected><?php echo $rows[5] ?></option>
                  <option value="有">有</option>
                  <option value="无">无</option>
                </select>
              </td>
            ...
            <tr>
              ...
              <td class="td_bg">
                <select name="hasTV">
                  <option value="<?php echo $rows[6] ?>" selected><?php echo $rows[6] ?></option>
                  <option value="有">有</option>
                  <option value="无">无</option>
                </select>
              </td>
            ...
            <tr>
              <td align="right" class="td_bg">浴室：</td>
              <td class="td_bg">
                <select name="hasWC">
            ...
            <tr>
              ...
              <td class="td_bg"><input name="price" type="text" id="price" value="<?php echo $rows[8] ?>" size="10" maxlength="15" />元</td>
            </tr>
            <tr>
              <td align="right" class="td_bg">房间数量：</td>
              <td class="td_bg"><input name="totalnum" type="text" id="totalnum" value="<?php echo $rows[9] ?>" size="10" maxlength="15" />间</td>
            </tr>
            <tr>
              <td align="right" class="td_bg">剩余数量：</td>
              <td class="td_bg"><input name="leftnum" type="text" id="leftnum" value="<?php echo $rows[10] ?>" size="10" maxlength="15" />间</td>
            </tr>
            <tr>
