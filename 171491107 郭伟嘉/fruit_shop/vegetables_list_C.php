...
<?php 
require("connect.php");
$myquery = mysql_query("select count(*) from fruit where lb='蔬菜'",$db);
...
$querysql = "select * from fruit where lb='蔬菜' limit $query_start, $page_size"; //使用MySQL独有的limit子句获取记录
...
?>
  <tr bgcolor="#FFCCCC"><td colspan="7" align="center">
...
?>
<a href="vegetables_list_list.php?p=<?php echo $page ?>"> <?php echo "<center>".$pager . " 页</center>"; ?> </a>&nbsp;
<?php }?>
  </td></tr>
</table>
</body>
